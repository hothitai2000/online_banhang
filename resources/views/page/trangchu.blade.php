                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-caption">
                                            ...
                                            {{-- <a class="beta-btn primary" href="{{ route('wishlist.add', $new->id) }}"><i class="fa fa-heart" >Wishlist</i></a> --}}
                                            <form method="POST" action="{{ route('wishlist.add', $new->id) }}">
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-caption">
                                            ...
                                            <form method="POST" action="{{ route('wishlist.add', $spkm->id) }}">
                                                <input type="hidden" name="_method" value="POST">
                                                <button type="submit"  class="btn btn-primary">
                                                  <i class="fa fa-heart"></i> Wishlist
                                                </button>
